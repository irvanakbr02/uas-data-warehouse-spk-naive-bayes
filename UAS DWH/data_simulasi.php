        ...
        <table id="dataLatih" class="display pt-3 mb-3">
          ...
          <?php
            ...
            foreach ($hasil as $hasil) {
              ...
              if($hasil['kesehatanmata'] == "sehat"){
                $sehatmata = "sehat";
              }else if($hasil['kesehatanmata'] == "tidak_sehat1"){
                $sehatmata = "Mines 0,25 - 2";
              }else if($hasil['kesehatanmata'] == "tidak_sehat2"){
                $sehatmata = "Mines lebih dari 2";
              }

              if($hasil['kesehatanjasmani'] == "sehat"){
                $sehatjasmani = "sehat";
              }else if($hasil['kesehatanjasmani'] == "tidak_sehat"){
                $sehatjasmani = "tidak sehat";
              }
          ?>
            ...
            <tr>
              ...
              <td><?php echo $hasil['nilaiun']; ?></td>
              <td><?php echo $sehatmata ?></td>
              <td><?php echo $tinggi ?></td>
              <td><?php echo $sehatjasmani ?></td>
              <td><?php 
              if($stt == "diterima"){
